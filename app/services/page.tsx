...
export default function ServicesPage() {
  ...
  return (
    <>
      ...
      <section className="bg-[#f9f9f9] pt-[72px]" style={{ fontFamily: SATOSHI }}>
        <div className="max-w-[1240px] mx-auto px-4 md:px-8 py-12 md:py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-end">
            <h1
              className="text-[38px] md:text-[52px] lg:text-[64px] font-[700] leading-[1.0] tracking-[-0.04em] text-neutral-900"
              style={{ fontFamily: SATOSHI }}
            >
            ...
            <div className="pb-2 flex flex-col items-start md:items-end">
      ...
      {/* SOLUTIONS */}
      <section id="solutions" className="px-6 md:px-12 bg-white py-16 md:py-32" style={{ fontFamily: SATOSHI }}>
        <div className="max-w-[1240px] mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-6 mb-10 md:mb-16">
            ...
            <SplitText
              className="w-full md:flex-[1_0_0px] md:max-w-[500px] text-neutral-900 text-[16px] font-[500] leading-relaxed"
              stagger={0.03}
            >
      ...
      {/* ABOUT */}
      <section id="company" className="py-16 md:py-32 px-6 md:px-12 bg-white" style={{ fontFamily: SATOSHI }}>
        <div className="max-w-[1240px] mx-auto">
            ...
            <div className="flex flex-col">
              ...
              <div className="mt-auto pt-8">
                <div className="bg-[#f9f9f9] rounded-tl-2xl rounded-bl-2xl rounded-br-2xl p-8" style={{ clipPath: "polygon(0 0, calc(100% - 32px) 0, 100% 32px, 100% 100%, 0 100%)" }}>
                  <SplitText
                    className="text-[26px] font-[700] leading-[1.1] tracking-[-0.04em] mb-4 text-neutral-900"
                    style={{ fontFamily: SATOSHI }}
                  >
                  ...
                  <button
                    onClick={() => setShowCalendly(true)}
                    className="group flex items-center rounded-sm overflow-hidden border border-neutral-300 hover:border-neutral-500 transition-colors duration-200"
                  >
